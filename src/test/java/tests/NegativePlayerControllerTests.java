...
public class NegativePlayerControllerTests extends BaseTest {
    ...
    public void testUpdatePlayerNegative() {
        ...
        PlayerDto updatedPlayer = new PlayerDto(15, "PatchedUser", "PatrchedUserOne", "male", "user", "password123");
    ...
    public void testCreatePlayerNegativeWithEmptyPassword() {
        ...
        Integer statusCode = createPlayerWithResponse(new PlayerDto(20, "Mucha", "Mucha33", "male", "user", ""), "supervisor").statusCode();

        assertEquals(statusCode, 400, "Wrong status code for empty password");
    }

    @Test
    public void testCreatePlayerNegativeWithTooShortPassword() {
        Allure.step("Trying to create player with too short password");
        Integer statusCode = createPlayerWithResponse(new PlayerDto(20, "ShortPass", "TooShortPass", "male", "user", "12"), "supervisor").statusCode();

        assertEquals(statusCode, 400, "Wrong status code for too short password");
    }
